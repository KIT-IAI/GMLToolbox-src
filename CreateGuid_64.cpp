...
void CreateReadableStringFromGuid (GUID *pGuid, wchar_t * guid);
...
void CreateReadableStringFromGuid (GUID *pGuid, char *guid)
{
	unsigned char * string;
	UuidToString(pGuid,  &string);
    strcpy (guid, (char*) string);
	RpcStringFree (&string); 
}

void CreatetGuidFromReadableString (char *guid, GUID *pGuid)
{
  UuidFromString((unsigned char*)guid, pGuid);
}
