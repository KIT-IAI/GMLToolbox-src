...
:
SET maindir="C:\EnergyPlusV8-8-0\"
...
SET numProc=1
   SET weather=%~1
:  SET weather="V:\[CityGML]\[CityGML-Energy]\EnergyPlus\Test-Eingabe\EPlusSimulation\Meteonorm.epw"
...
echo CALL ..\RunEPlus.bat "%~dpn1"     %weather% >>.\tempsim%group%\simpart%group%.bat 
