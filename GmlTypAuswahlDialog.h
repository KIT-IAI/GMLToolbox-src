...
#include "includes.h"
	...
	public:
      ...
      if ( typLocal == XPLANGML_5_3 )
        radioButtonXPlanGML_5_3->Checked = true;
      else
...
#pragma region Windows Form Designer generated code
      ...
      this->radioButtonINSPIRE_Planned_LU->Location = System::Drawing::Point( 13, 204 );
      ...
      this->buttonBeenden->Location = System::Drawing::Point( 109, 243 );
      ...
      this->ClientSize = System::Drawing::Size( 292, 291 );
      this->Controls->Add( this->radioButtonXPlanGML_5_3 );
...
private: System::Void buttonBeenden_Click(System::Object^  sender, System::EventArgs^  e)
{
  ...
  if ( radioButtonXPlanGML_5_3->Checked )
    typLocal = XPLANGML_5_3;
  else
