        ...
        namespace Plugin {
            ...
            public:
                static Type^ CheckAssembly(String^ assemblyFile)
                {
                    ...
                    {
                        auto str = String::Format("The plugin file {0} could not be loaded. The plugin is ignored this time."
                            + "\r\n\r\n{1}", assemblyFile, ex->Message);
                        MessageBox::Show(str, "Plugin Loader Information", MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
                    }
